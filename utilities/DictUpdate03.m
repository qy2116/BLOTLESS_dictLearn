...
%     if mod(itn,dispN) == 0
%         if DebugFlag == 1
%             fprintf('itn=%d: f=%3.3e: freal=%3.3e: gn2=%3.3e: topt=%3.3e: CondNum=%3.3e: time=%f\n',...
%                 itn,OPara.f1(itn),OPara.f1real(itn),OPara.gn2(itn),OPara.topt(itn),OPara.CondNum(itn),toc);
%         else
%             fprintf('itn=%d: f=%3.3e: freal=%3.3e: gn2=%3.3e: topt=%3.3e: time=%f\n',...
%                 itn,OPara.f1(itn),OPara.f1real(itn),OPara.gn2(itn),OPara.topt(itn),toc);
%         end
%         tic;
%     end
end
